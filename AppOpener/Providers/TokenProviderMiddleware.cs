	...
	public class TokenProviderMiddleware
	{
		...
		private async Task GenerateToken(HttpContext context)
		{
			...
			else
			{
				...
				authMode = context.Request.Form["authMode"];
			}

			var identity = await _options.IdentityResolver(username, password, authMode, granttype, clientId, clientsecret);
			if (identity == null)
			{
				context.Response.StatusCode = 400;
			...
			if (granttype == "client_credentials")
			{
				clientId = identity.FindFirst("clientId").Value;
				var response = new
				{
